...
namespace HNTAS.Web.UI.Services.Core
{
    public interface IUserService
    {
        ...
        Task<PagedResultOfManagedUserResponse> GetDdhAndContributorsPaginated(string userId, bool networkManagersOnly = false, int pageNumber = 1, int pageSize = 1, string sortBy = "firstName", string sortDirection = "asc", CancellationToken cancellationToken = default);
    }
}
