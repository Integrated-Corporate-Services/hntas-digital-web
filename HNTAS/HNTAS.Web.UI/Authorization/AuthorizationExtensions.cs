    ...
    public static class AuthorizationExtensions
    {
        public static IServiceCollection AddApplicationAuthorization(this IServiceCollection services)
        {
            ...
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy(SecurityConstants.Policies.CanAddContributingOrganisation, p => p.Requirements.Add(new RolesRequirement(UserRole.Coordinator, UserRole.Contractor, UserRole.Contributor, UserRole.Operator)));
