    ...
    public class OrgDetails2JsonConverter : JsonConverter<OrgDetails2>
    {
        ...
        public override OrgDetails2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!companiesHouseNumber.IsSet)
                throw new ArgumentException("Property is required for class OrgDetails2.", nameof(companiesHouseNumber));
            ...
            if (companiesHouseNumber.IsSet && companiesHouseNumber.Value == null)
                throw new ArgumentNullException(nameof(companiesHouseNumber), "Property is not nullable for class OrgDetails2.");
            ...
            return new OrgDetails2(orgType.Value!, companiesHouseNumber.Value!, orgName.Value!, firstName.Value!, lastName.Value!, preferredContactType.Value!.Value!, orgRegisteredAddress.Value!, orgId, landlineNumber, contactNumberExtension, mobileNumber, jobTitle.Value!);
        }
        ...
        {
            if (orgDetails2.OrgType == null)
                throw new ArgumentNullException(nameof(orgDetails2.OrgType), "Property is required for class OrgDetails2.");

            if (orgDetails2.CompaniesHouseNumber == null)
                throw new ArgumentNullException(nameof(orgDetails2.CompaniesHouseNumber), "Property is required for class OrgDetails2.");
            ...
            writer.WriteString("orgType", orgDetails2.OrgType);
