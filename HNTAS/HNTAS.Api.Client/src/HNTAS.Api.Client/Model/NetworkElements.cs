...
namespace HNTAS.Api.Client.Model
{
    ...
    public partial class NetworkElements : IValidatableObject
    {
        ...
        [JsonConstructor]
        public NetworkElements(Option<NetworkDetailsStatus?> status = default, Option<NetworkDetailsStatus?> elementSoaStatus = default, Option<List<Element>?> elements = default, Option<DateTimeOffset?> createdAt = default, Option<string?> createdBy = default, Option<DateTimeOffset?> updatedAt = default, Option<string?> updatedBy = default)
        {
            StatusOption = status;
    ...
    public class NetworkElementsJsonConverter : JsonConverter<NetworkElements>
    {
        ...
        public override NetworkElements Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new NetworkElements(status, elementSoaStatus, elements, createdAt, createdBy, updatedAt, updatedBy);
        }
