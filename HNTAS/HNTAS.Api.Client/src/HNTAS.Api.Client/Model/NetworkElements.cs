...
namespace HNTAS.Api.Client.Model
{
    ...
    public partial class NetworkElements : IValidatableObject
    {
        ...
        [JsonConstructor]
        public NetworkElements(Option<NetworkDetailsStatus?> networkElementStatus = default, Option<NetworkDetailsStatus?> elementSoaStatus = default, Option<List<Element>?> elements = default, Option<List<ElementGroup>?> elementsGroup = default, Option<DateTimeOffset?> createdAt = default, Option<string?> createdBy = default, Option<DateTimeOffset?> updatedAt = default, Option<string?> updatedBy = default)
        {
    ...
    public class NetworkElementsJsonConverter : JsonConverter<NetworkElements>
    {
        ...
        public override NetworkElements Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (elementsGroup.IsSet && elementsGroup.Value == null)
                throw new ArgumentNullException(nameof(elementsGroup), "Property is not nullable for class NetworkElements.");
            ...
            return new NetworkElements(networkElementStatus, elementSoaStatus, elements, elementsGroup, createdAt, createdBy, updatedAt, updatedBy);
        }
        ...
        {
            if (networkElements.ElementsGroupOption.IsSet && networkElements.ElementsGroup == null)
                throw new ArgumentNullException(nameof(networkElements.ElementsGroup), "Property is required for class NetworkElements.");
            ...
            if (networkElements.ElementsOption.IsSet)
                if (networkElements.ElementsOption.Value != null)
                {
            ...
            if (networkElements.ElementsGroupOption.IsSet)
            {
                writer.WritePropertyName("elementsGroup");
                JsonSerializer.Serialize(writer, networkElements.ElementsGroup, jsonSerializerOptions);
            }
