...
namespace HNTAS.Api.Client.Model
{
    ...
    public partial class AssessmentPlan : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AssessmentPlan(Option<AssessmentPlanStatus?> status = default, Option<DateTimeOffset?> createdAt = default, Option<string?> createdBy = default, Option<DateTimeOffset?> updatedAt = default, Option<string?> updatedBy = default)
        {
            StatusOption = status;
        ...
        public Option<AssessmentPlanStatus?> StatusOption { get; private set; }

        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        [JsonPropertyName("status")]
        public AssessmentPlanStatus? Status { get { return this.StatusOption; } set { this.StatusOption = new(value); } }
    ...
    public class AssessmentPlanJsonConverter : JsonConverter<AssessmentPlan>
    {
        ...
        public override AssessmentPlan Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<AssessmentPlanStatus?> status = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<AssessmentPlanStatus?>(AssessmentPlanStatusValueConverter.FromStringOrDefault(statusRawValue));
                            break;
                        case "createdAt":
        ...
        public void WriteProperties(Utf8JsonWriter writer, AssessmentPlan assessmentPlan, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            {
                var statusRawValue = AssessmentPlanStatusValueConverter.ToJsonValue(assessmentPlan.Status!.Value);
