...
namespace HNTAS.Api.Client.Model
{
    ...
    public partial class HeatNetwork2 : IValidatableObject
    {
        ...
        [JsonConstructor]
        public HeatNetwork2(Option<string?> id = default, Option<string?> uHnId = default, Option<string?> hnId = default, Option<string?> name = default, Option<string?> additionalDescription = default, Option<RegisteredAddress?> address = default, Option<ECDetails2?> ecDetails = default, Option<string?> pathway = default, Option<RegistrationSource?> registrationSource = default, Option<HeatNetworkType?> heatNetworkType = default, Option<HeatNetworkConnections2?> heatNetworkConnections = default, Option<NetworkElements?> networkElements = default, Option<Soa?> soa = default, Option<MeteringAndMonitoringStrategy?> meteringAndMonitoringStrategy = default, Option<AssessmentPlan?> assessmentPlan = default, Option<DesignConstructionLog?> designConstructionLog = default, Option<string?> createdBy = default, Option<DateTimeOffset?> createdAt = default, Option<string?> phase = default)
        {
            IdOption = id;
            UHnIdOption = uHnId;
            HnIdOption = hnId;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<HeatNetworkConnections2?> HeatNetworkConnectionsOption { get; private set; }

        /// <summary>
        /// Gets or Sets HeatNetworkConnections
        /// </summary>
        [JsonPropertyName("heatNetworkConnections")]
        public HeatNetworkConnections2? HeatNetworkConnections { get { return this.HeatNetworkConnectionsOption; } set { this.HeatNetworkConnectionsOption = new(value); } }
    ...
    public class HeatNetwork2JsonConverter : JsonConverter<HeatNetwork2>
    {
        ...
        public override HeatNetwork2 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<HeatNetworkConnections2?> heatNetworkConnections = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "heatNetworkConnections":
                            heatNetworkConnections = new Option<HeatNetworkConnections2?>(JsonSerializer.Deserialize<HeatNetworkConnections2>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
            ...
            if (pathway.IsSet && pathway.Value == null)
                throw new ArgumentNullException(nameof(pathway), "Property is not nullable for class HeatNetwork2.");
            ...
            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class HeatNetwork2.");

            if (phase.IsSet && phase.Value == null)
                throw new ArgumentNullException(nameof(phase), "Property is not nullable for class HeatNetwork2.");

            return new HeatNetwork2(id, uHnId, hnId, name, additionalDescription, address, ecDetails, pathway, registrationSource, heatNetworkType, heatNetworkConnections, networkElements, soa, meteringAndMonitoringStrategy, assessmentPlan, designConstructionLog, createdBy, createdAt, phase);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, HeatNetwork2 heatNetwork2, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (heatNetwork2.PathwayOption.IsSet && heatNetwork2.Pathway == null)
                throw new ArgumentNullException(nameof(heatNetwork2.Pathway), "Property is required for class HeatNetwork2.");
            ...
            if (heatNetwork2.PhaseOption.IsSet && heatNetwork2.Phase == null)
                throw new ArgumentNullException(nameof(heatNetwork2.Phase), "Property is required for class HeatNetwork2.");
