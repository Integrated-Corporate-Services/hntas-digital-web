...
namespace HNTAS.Api.Client.Model
{
    ...
    public partial class OrgDetails : IValidatableObject
    {
        ...
        [JsonConstructor]
        public OrgDetails(string orgType, string companiesHouseNumber, string orgName, string firstName, string lastName, PreferredContactType preferredContactType, OrgRegisteredAddress orgRegisteredAddress, Option<int?> orgId = default, Option<string?> landlineNumber = default, Option<string?> contactNumberExtension = default, Option<string?> mobileNumber = default, string? jobTitle = default)
        {
            OrgType = orgType;
        ...
        public void WriteProperties(Utf8JsonWriter writer, OrgDetails orgDetails, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (orgDetails.OrgIdOption.IsSet)
                if (orgDetails.OrgIdOption.Value != null)
                    writer.WriteNumber("orgId", orgDetails.OrgIdOption.Value!.Value);
                else
