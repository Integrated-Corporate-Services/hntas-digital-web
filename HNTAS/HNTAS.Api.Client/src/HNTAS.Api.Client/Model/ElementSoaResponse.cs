...
namespace HNTAS.Api.Client.Model
{
    ...
    public partial class ElementSoaResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ElementSoaResponse(Option<NetworkDetailsStatus?> status = default, Option<List<Elements>?> elements = default, Option<DateTimeOffset?> createdAt = default, Option<string?> createdBy = default, Option<DateTimeOffset?> updatedAt = default, Option<string?> updatedBy = default)
        {
            StatusOption = status;
    ...
    public class ElementSoaResponseJsonConverter : JsonConverter<ElementSoaResponse>
    {
        ...
        public override ElementSoaResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (elements.IsSet && elements.Value == null)
                throw new ArgumentNullException(nameof(elements), "Property is not nullable for class ElementSoaResponse.");

            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class ElementSoaResponse.");

            return new ElementSoaResponse(status, elements, createdAt, createdBy, updatedAt, updatedBy);
        }
        ...
        {
            if (elementSoaResponse.ElementsOption.IsSet && elementSoaResponse.Elements == null)
                throw new ArgumentNullException(nameof(elementSoaResponse.Elements), "Property is required for class ElementSoaResponse.");
            ...
            if (elementSoaResponse.ElementsOption.IsSet)
            {
                writer.WritePropertyName("elements");
                JsonSerializer.Serialize(writer, elementSoaResponse.Elements, jsonSerializerOptions);
            }
