...
namespace HNTAS.Api.Client.Model
{
    ...
    public partial class Soa : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Soa(Option<SoaStatus?> status = default, Option<DateTimeOffset?> createdAt = default, Option<string?> createdBy = default, Option<DateTimeOffset?> updatedAt = default, Option<string?> updatedBy = default, Option<SoaJourneyData?> journeyData = default)
        {
            StatusOption = status;
    ...
    public class SoaJsonConverter : JsonConverter<Soa>
    {
        ...
        public override Soa Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Soa(status, createdAt, createdBy, updatedAt, updatedBy, journeyData);
        }
