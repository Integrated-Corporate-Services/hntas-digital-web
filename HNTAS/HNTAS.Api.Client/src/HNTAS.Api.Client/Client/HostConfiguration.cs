...
namespace HNTAS.Api.Client.Client
{
    ...
    public class HostConfiguration
    {
        ...
        public HostConfiguration(IServiceCollection services)
        {
            ...
            _jsonOptions.Converters.Add(new AssessmentPlanDocumentJsonConverter());
            _jsonOptions.Converters.Add(new AssessmentPlanDocumentResponseJsonConverter());
            ...
            _jsonOptions.Converters.Add(new UpdateAssessmentPlanRequestJsonConverter());
